...
export default function ThemeSwitcher({ theme, setTheme }: Readonly<ThemeSwitcherProps>) {
  ...
  return (
    <S.ThemeDiv>
      <S.ThemeSwitch onChange={() => handleChange()} checked={theme.title === "light"}></S.ThemeSwitch>
